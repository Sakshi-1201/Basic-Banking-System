...
<body>
  ...
  <nav class="navbar navbar-expand-lg  bg-light">
    <a class="navbar-brand">S B N</a>
    <img src="Images/icon.jpg" width="25px" height="25px" alt="">
    ...
    <tbody>
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          echo "<tr><td>" . $row["Customer id"] . "</td><td>" . $row["Customer name"] . "</td><td>" . $row["E-Mail ID"] . "</td><td>" . $row["Bank Balance"] . "</td></tr>";
        }
      } else {
        echo "0 results";
      }
